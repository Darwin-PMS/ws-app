...
const styles = StyleSheet.create({
    ...
    categoryIcon: { width: 30, height: 30, borderRadius: 6, justifyContent: 'center', alignItems: 'center' },
    ...
    serviceRow1: { flexDirection: 'row', alignItems: 'center', gap: 6 },
    serviceIconWrapper: { width: 30, height: 30, borderRadius: 8, justifyContent: 'center', alignItems: 'center' },
    serviceTitle: { fontSize: 14, fontWeight: '600', flex: 1 },
